...
import com.daletcode.exception.BadRequestErrorException;
import com.daletcode.exception.InternalServerErrorException;
import com.daletcode.exception.UserNotFoundErrorException;
import com.daletcode.model.*;
import com.daletcode.repository.*;
...
//        final var assignToDeliveryPartner = deliveryPartners.getFirst();
        final var assignToDeliveryPartner = deliveryPartners.get(0);
        ...
        payment.setPaymentMethod(PaymentMethod.valueOf(String.valueOf(orderRequest.getPaymentRequest().getPaymentMethod())));
